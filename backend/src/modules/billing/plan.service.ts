...
export const PLAN_FEATURES: Record<PlanId, PlanFeatures> = {
  ...
  pro: {
    ...
    maxProducts: 10000,
    maxStorage: 50,
    features: ['5 users', '10,000 products', '50 GB storage', 'Advanced analytics', 'Priority support', 'Custom domain', 'API access'],
  ...
  enterprise: {
    ...
    maxProducts: -1,
    maxStorage: -1,
    features: ['Unlimited users', 'Unlimited products', 'Unlimited storage', 'Full analytics', 'Dedicated support', 'Custom domain', 'API access', 'SSO', 'SLA'],
